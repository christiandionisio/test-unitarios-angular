...
describe('MedicosComponent', () => {
    ...
    it('Si falla la adición, la propiede mensajeError, debe ser igual al error del servicio', () => {
    ...
    it('Debe de llamar al servidor para borrar al médico', () => {
    ...
    it('No debe de llamar al servidor para borrar al médico', () => {
